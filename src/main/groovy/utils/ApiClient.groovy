...
class ApiClient {
    ...
    def request(path, query) {
        ...
        try {
            ...
            CommandLineLogger.log("[WARNING] HttpResponseException occurred, the reason might be the repo is empty, or rate limit, skip this one. Detailed error message: ${e.message}")
            CommandLineLogger.log("[WARNING] path: ${path}, query: ${query}, skipped.")
        }
